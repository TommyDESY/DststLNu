...
from xulnu.utility import mc_pdg_codes, pdg_to_string_dict
...
def run_BtoXcLepNu_hammer(df: pd.DataFrame,
    ...
    # mask = np.logical_or(xulnu.utility.get_decay_mask(df, {511: [xulnu.utility.Xc_PDG_codes, [11, 13], [12, 14]]}),
    #                      xulnu.utility.get_decay_mask(df, {521: [xulnu.utility.Xc_PDG_codes, [11, 13], [12, 14]]}))
